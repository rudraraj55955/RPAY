...
export const plansTable = pgTable("plans", {
  ...
  monthlyFee: text("monthly_fee").notNull().default("0"),
  yearlyFee: text("yearly_fee").notNull().default("0"),
  setupFee: text("setup_fee").notNull().default("0"),
  ...
  providerAccess: boolean("provider_access").notNull().default(false),
