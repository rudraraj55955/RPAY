...
const mutationKey = ['retryReportDeliveryLog'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof retryReportDeliveryLog>>, {id: number}> = (props) => {
          const {id} = props ?? {};

          return  retryReportDeliveryLog(id,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type RetryReportDeliveryLogMutationResult = NonNullable<Awaited<ReturnType<typeof retryReportDeliveryLog>>>

    export type RetryReportDeliveryLogMutationError = ErrorType<void>

    /**
 * @summary Merchant — retry a specific failed delivery log entry immediately
 */
export const useRetryReportDeliveryLog = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof retryReportDeliveryLog>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof retryReportDeliveryLog>>,
        TError,
        {id: number},
        TContext
      > => {
...
export const getGetNotificationUnreadCountsUrl = () => {




  return `/api/notifications/unread-counts`
}

/**
 * @summary Get unread notification counts grouped by type
 */
export const getNotificationUnreadCounts = async ( options?: RequestInit): Promise<NotificationUnreadCounts> => {

  return customFetch<NotificationUnreadCounts>(getGetNotificationUnreadCountsUrl(),
  {
    ...options,
    method: 'GET'
...
export const getGetNotificationUnreadCountsQueryKey = () => {
    return [
...
export const getGetNotificationUnreadCountsQueryOptions = <TData = Awaited<ReturnType<typeof getNotificationUnreadCounts>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getNotificationUnreadCounts>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetNotificationUnreadCountsQueryKey();



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getNotificationUnreadCounts>>> = ({ signal }) => getNotificationUnreadCounts({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getNotificationUnreadCounts>>, TError, TData> & { queryKey: QueryKey }
}

export type GetNotificationUnreadCountsQueryResult = NonNullable<Awaited<ReturnType<typeof getNotificationUnreadCounts>>>
export type GetNotificationUnreadCountsQueryError = ErrorType<unknown>
...
export function useGetNotificationUnreadCounts<TData = Awaited<ReturnType<typeof getNotificationUnreadCounts>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getNotificationUnreadCounts>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getGetNotificationUnreadCountsQueryOptions(options)
 ...
 */
export const getWebhookRetriesConfig = async ( options?: RequestInit): Promise<WebhookRetriesConfig> => {

  return customFetch<WebhookRetriesConfig>(getGetWebhookRetriesConfigUrl(),
  {
    ...options,
    method: 'GET'
...
export const getGetWebhookRetriesConfigQueryKey = () => {
    return [
...
export const getGetWebhookRetriesConfigQueryOptions = <TData = Awaited<ReturnType<typeof getWebhookRetriesConfig>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getWebhookRetriesConfig>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetWebhookRetriesConfigQueryKey();



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getWebhookRetriesConfig>>> = ({ signal }) => getWebhookRetriesConfig({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getWebhookRetriesConfig>>, TError, TData> & { queryKey: QueryKey }
}

export type GetWebhookRetriesConfigQueryResult = NonNullable<Awaited<ReturnType<typeof getWebhookRetriesConfig>>>
export type GetWebhookRetriesConfigQueryError = ErrorType<unknown>
...
export function useGetWebhookRetriesConfig<TData = Awaited<ReturnType<typeof getWebhookRetriesConfig>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getWebhookRetriesConfig>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getGetWebhookRetriesConfigQueryOptions(options)
...
export const getUpdateWebhookRetriesConfigUrl = () => {
 ...
 */
export const updateWebhookRetriesConfig = async (webhookRetriesConfig: WebhookRetriesConfig, options?: RequestInit): Promise<WebhookRetriesConfig> => {

  return customFetch<WebhookRetriesConfig>(getUpdateWebhookRetriesConfigUrl(),
  {
    ...options,
    method: 'PUT',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getUpdateWebhookRetriesConfigMutationOptions = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateWebhookRetriesConfig>>, TError,{data: BodyType<WebhookRetriesConfig>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updateWebhookRetriesConfig>>, TError,{data: BodyType<WebhookRetriesConfig>}, TContext> => {

const mutationKey = ['updateWebhookRetriesConfig'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateWebhookRetriesConfig>>, {data: BodyType<WebhookRetriesConfig>}> = (props) => {
          const {data} = props ?? {};

          return  updateWebhookRetriesConfig(data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UpdateWebhookRetriesConfigMutationResult = NonNullable<Awaited<ReturnType<typeof updateWebhookRetriesConfig>>>
    export type UpdateWebhookRetriesConfigMutationBody = BodyType<WebhookRetriesConfig>
    export type UpdateWebhookRetriesConfigMutationError = ErrorType<ErrorResponse>

    /**
 * @summary Update webhook retry delay configuration (admin only)
 */
export const useUpdateWebhookRetriesConfig = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateWebhookRetriesConfig>>, TError,{data: BodyType<WebhookRetriesConfig>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof updateWebhookRetriesConfig>>,
        TError,
        {data: BodyType<WebhookRetriesConfig>},
        TContext
      > => {
...
export const getGetSupportTicketQueryOptions = <TData = Awaited<ReturnType<typeof getSupportTicket>>, TError = ErrorType<ErrorResponse>>(id: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getSupportTicket>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
export const getAddTicketReplyUrl = (id: number,) => {
 ...
 */
export const addTicketReply = async (id: number,
    addTicketReplyInput: AddTicketReplyInput, options?: RequestInit): Promise<TicketReply> => {

  return customFetch<TicketReply>(getAddTicketReplyUrl(id),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getAddTicketReplyMutationOptions = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof addTicketReply>>, TError,{id: number;data: BodyType<AddTicketReplyInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof addTicketReply>>, TError,{id: number;data: BodyType<AddTicketReplyInput>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof addTicketReply>>, {id: number;data: BodyType<AddTicketReplyInput>}> = (props) => {
          const {id,data} = props ?? {};

          return  addTicketReply(id,data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type AddTicketReplyMutationBody = BodyType<AddTicketReplyInput>
    export type AddTicketReplyMutationError = ErrorType<ErrorResponse>

    /**
 * @summary Add a reply to a support ticket
 */
export const useAddTicketReply = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof addTicketReply>>, TError,{id: number;data: BodyType<AddTicketReplyInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof addTicketReply>>,
        TError,
        {id: number;data: BodyType<AddTicketReplyInput>},
        TContext
      > => {
      return useMutation(getAddTicketReplyMutationOptions(options));
    }

export const getGetSupportTicketStatsUrl = () => {
 ...
 */
export const getSupportTicketStats = async ( options?: RequestInit): Promise<SupportTicketStats> => {

  return customFetch<SupportTicketStats>(getGetSupportTicketStatsUrl(),
  {
    ...options,
    method: 'GET'
...
export const getGetSupportTicketStatsQueryKey = () => {
    return [
...
export const getGetSupportTicketStatsQueryOptions = <TData = Awaited<ReturnType<typeof getSupportTicketStats>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getSupportTicketStats>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetSupportTicketStatsQueryKey();



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getSupportTicketStats>>> = ({ signal }) => getSupportTicketStats({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getSupportTicketStats>>, TError, TData> & { queryKey: QueryKey }
}

export type GetSupportTicketStatsQueryResult = NonNullable<Awaited<ReturnType<typeof getSupportTicketStats>>>
export type GetSupportTicketStatsQueryError = ErrorType<unknown>
...
export function useGetSupportTicketStats<TData = Awaited<ReturnType<typeof getSupportTicketStats>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getSupportTicketStats>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getGetSupportTicketStatsQueryOptions(options)
