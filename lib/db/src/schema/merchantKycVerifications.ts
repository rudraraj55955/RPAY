...
export const merchantKycVerificationsTable = pgTable("merchant_kyc_verifications", {
  ...
  aadhaarOtpSessionEncrypted: text("aadhaar_otp_session_encrypted"),
  aadhaarOtpSessionIv: text("aadhaar_otp_session_iv"),
  aadhaarOtpSessionTag: text("aadhaar_otp_session_tag"),
